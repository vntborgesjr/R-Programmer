# --------------------------------------------------- 
# Working with Dates and Times in R - Dates and Times in R
# 22 dez 2020 
# VNTBJR 
# --------------------------------------------------- 
#
...
# POISXlt - stores date in a list with components for 
# each unit
# POSIXct - stores date as the number of seconds since the 
# beginning of 1970
